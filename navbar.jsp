	...
	<div class="row">
		...
		<a href="checkout.jsp"><i class="fa-solid fa-cart-plus fa-2x"></i></a>
			...
			<a href="login.jsp" class="btn btn-success"><i
				class="fa-solid fa-user-plus"></i> ${userobject.name }</a> <a
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link" href="ViewRecentBook.jsp"><i
					class="fa-solid fa-book-open"></i> Recent Book</a></li>
			<li class="nav-item active"><a class="nav-link" href="ViewNewBook.jsp"><i
					class="fa-solid fa-book-open"></i> New Book</a></li>
			<li class="nav-item active"><a class="nav-link disabled"
				href="ViewOldBook.jsp"><i class="fa-solid fa-book-open"></i> Old Book</a></li>
		</ul>
