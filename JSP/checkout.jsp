...
<%@page import="com.demo.entity.Cart"%>
<%@page import="com.demo.entity.User"%>
<%@page import="com.demo.dao.DBUtil"%>
<%@page import="com.demo.dao.CartDaoImpl"%>
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Name</label> <input type="text" name="userName"
										class="form-control" id="inputEmail4" value="${userobject.name }" required="required">
								</div>
								<div class="form-group col-md-6">
									<label for="inputPassword4">Email</label> <input type="email" name="email"
										class="form-control" id="inputPassword4" value="${userobject.email }" required="required">
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Mobile No</label> <input type="number" name="phno"
										class="form-control" id="inputEmail4" value="${userobject.phno }" required="required">
								</div>
								<div class="form-group col-md-6">
